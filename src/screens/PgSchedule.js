...
import {ListPG } from '../apiservice/OwnerApi';
import { responsiveFontSize } from "react-native-responsive-dimensions";
const { width, height } = Dimensions.get("window");



function PgSchedule (props) {
  ...
  const handleTimeConfirm = (time) => {
    ...
    hideTimePicker();
      ...
      const handleFinish = async () => { 
        ...
        try {
          setLoading(true);
          const response = await ListPG(pgData ,PGRoomDetails,Locality,PGdetails,PGAmenities,PGphotos,schedule);
