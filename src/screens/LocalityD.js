...
const [dataCity, setdataCity] = useState(ForCity);// for Guest
        ...
        const HandleLocality = () =>{
          ...
          navigation.navigate('PhotoS', {FlatDetails,PropertyDeatils,RentalCondition,ammenities,Loaclity});
        }
